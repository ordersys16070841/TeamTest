...
<div class="container">
    <form action="clientLogin" method="post" class="form-horizontal"
          style="margin-left: 10%;margin-right: 10%;margin-top: 7%;margin-bottom: 7%">
        <table class="table table-striped table-hover">
            <tr>
                <td>用户名：</td>
                <td><input type="text" class="form-control" placeholder="用户名" name="cacot"/></td>
            </tr>
            <tr>
                <td>密码：</td>
            ...
            <tr>
                <td colspan="2">
                    <button type="submit" class="btn btn-outline-primary">客户登录</button>
                </td>
            </tr>
        </table>
    </form>
