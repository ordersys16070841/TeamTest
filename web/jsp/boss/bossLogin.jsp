...
<div class="container">
    <form action="bossLogin" method="post" class="form-horizontal"
        ...
        <table class="table table-striped table-hover">
            <tr>
                <td>用户名：</td>
                <td><input type="text" class="form-control" placeholder="用户名" name="bacot" /></td>
            </tr>
            <tr>
                <td>密码：</td>
                <td><input type="password" class="form-control" placeholder="密码" name="bpsd" /></td>
            </tr>
            <tr>
                <td colspan="2">${loginMsg}</td>
            </tr>
            <tr>
                <td colspan="2"><button type="submit" class="btn btn-outline-primary">店长登录</button></td>
            </tr>
        </table>
    </form>
</div>
