                ...
                <div class="header_content d-flex flex-row align-items-center justify-content-center">
                    ...
                    <div class="logo">
                        <a href="#" class="d-flex flex-row align-items-end justify-content-start">
                            ...
                            <span class="logo_text">Cloud Music</span>
                        </a>
                    </div>
                    ...
                    <nav class="main_nav">
                        <ul class="d-flex flex-row align-items-center justify-content-start" id="na">
                            ...
                            <li><a href="${pageContext.request.contextPath}/allmusic">设置菜单</a></li>
                            <li><a href="${pageContext.request.contextPath}/myupload">认证账号</a></li>
                        </ul>
                    </nav>
                    ...
                    <div class="log_reg d-flex flex-row align-items-center justify-content-start">
                        <ul class="d-flex flex-row align-items-start justify-content-start navbar-nav">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a href="${pageContext.request.contextPath}/userinfo">Boss</a></li>
